    ...
    <div class="app-menu">
        <ul class="accordion-menu">
            <li class="sidebar-title mb-4"> <img src="<?php echo UPLOAD_IMG_ADMIN . htmlspecialchars($settings['admin_logo']); ?>" width="200"
                    alt="" style="object-fit: cover;" height="65px" /></li>
            ...
            <li>
                <a href="#"><i class="material-icons-two-tone">description</i>Design<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                <ul class="sub-menu">
                    <li><a href="add-content">Add Design</a></li>
                    <li><a href="manage-content">Manage Design</a></li>
                </ul>
            </li>
            <li>
                <a href="#"><i class="material-icons-two-tone">description</i>Projects<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                <ul class="sub-menu">
                    <li><a href="add-project">Add Project</a></li>
                    <li><a href="manage-project">Manage Project</a></li>
                </ul>
            </li>
            <!-- <li>
